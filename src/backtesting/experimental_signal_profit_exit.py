...
def print_period_results(
    ...
    for threshold in PROFIT_EXIT_THRESHOLDS:
        result = get_profit_exit_values(
            rows,
            threshold,
        )
...
def main():
    ...
    print()
    print(
        "EXPERIMENTAL SIGNAL PROFIT-EXIT TEST"
    )
    print(
    ...
    print(
        "At day 30, take profits on strong trades; "
    ...
    print(
        ...
        "The training period must determine whether a "
        "profit-taking rule deserves further testing."
    )
    print()
